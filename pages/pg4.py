...
dash.register_page(__name__,
                   path='/net-enrollment-secondary',  # represents the url text
                   name='Secondary net enrollment rate',  # name of page, commonly used as name of link
                   title='Secondary net enrollment rate'  # epresents the title of browser's tab
)


# page 1 data
df = pd.read_csv("datasets/escolarizacion_neta_secundaria.csv")
