...
dash.register_page(__name__,
                   path='/net-enrollment-primary',  # represents the url text
                   name='Primary net enrollment rate',  # name of page, commonly used as name of link
                   title='Primary net enrollment rate'  # epresents the title of browser's tab
)


# page 1 data
df = pd.read_csv("datasets/escolarizacion_neta_primaria.csv")
