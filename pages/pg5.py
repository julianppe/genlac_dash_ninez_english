...
dash.register_page(__name__,
                   path='/net-enrollment-tertiary',  # represents the url text
                   name='Tertiary net enrollment rate',  # name of page, commonly used as name of link
                   title='Tertiary net enrollment rate'  # epresents the title of browser's tab
)


# page 1 data
df = pd.read_csv("datasets/escolarizacion_neta_terciaria.csv")
