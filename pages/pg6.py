...
dash.register_page(__name__,
                   path='/primary-completion-rate',  # represents the url text
                   name='Primary completion rate',  # name of page, commonly used as name of link
                   title='Primary completion rate'  # epresents the title of browser's tab
)


# page 1 data
df = pd.read_csv("datasets/termino_primario.csv")
