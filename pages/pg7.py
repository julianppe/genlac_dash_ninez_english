...
dash.register_page(__name__,
                   path='/secondary-completion-rate',  # represents the url text
                   name='Secondary completion rate',  # name of page, commonly used as name of link
                   title='Secondary completion rate'  # epresents the title of browser's tab
)


# page 1 data
df = pd.read_csv("datasets/termino_secundario.csv")
